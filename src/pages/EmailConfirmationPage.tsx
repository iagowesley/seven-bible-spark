...
const EmailConfirmationPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#003366] to-[#001f4d] p-4">
      <Card className="w-full max-w-md bg-white shadow-xl">
        <CardHeader className="text-center pb-2">
          <div className="mx-auto w-16 h-16 flex items-center justify-center mb-4 rounded-full bg-[#f5f0fa]">
            {status === "loading" && (
              <div className="h-8 w-8 animate-spin rounded-full border-4 border-[#003366] border-t-transparent"></div>
            )}
        ...
        <CardContent className="text-center">
          ...
          {status === "success" && (
            <Button 
              ...
              className="w-full bg-[#003366] hover:bg-[#002b5c] text-white"
            >
              Ir para os Estudos
            </Button>
          )}
