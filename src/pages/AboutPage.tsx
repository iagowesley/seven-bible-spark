  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-50 dark:bg-neutral-900">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            <div className="flex flex-col items-center text-center space-y-8">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 max-w-xl text-lg font-light leading-relaxed">
                Um projeto dedicado a oferecer estudos diários relevantes para jovens adventistas, tornando a lição da escola sabatina mais acessível e envolvente.
              </p>
        ...
        {/* Nossos recursos - Cards minimalistas */}
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="md:w-1/2">
                <div className="instagram-container w-full max-w-sm mx-auto">
                  <div className="overflow-hidden rounded-lg shadow-sm" dangerouslySetInnerHTML={{ __html: `
